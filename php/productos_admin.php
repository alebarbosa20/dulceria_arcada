...
<head>
    ...
    <title>Dulcería Arcada | Productos</title>
...
<body>
    ...
    <div class="formulario">
        <form action="acciones_productos.php" method="post">
            ...
            <div class="opciones">
                ...
                <label for="alta" id="lbl-alta"><img src="..//img/agregar_productos.png" alt="">Agregar Producto</label>
                </div>

                <div class="opciones acciones">
                <input type="radio" name="opcion" id="baja" value="b" required>
                <label for="baja" id="lbl-baja"><img src="..//img/eliminar_productos.png" alt="">Eliminar Producto</label>
                </div>

                <div class="opciones acciones">
                <input type="radio" name="opcion" id="modificar" value="m" required>
                <label for="modificar" id="lbl-modificar"><img src="..//img/modificar_productos.png" alt="">Modificar Producto</label>
                </div>
                <?php } ?>

                <div class="opciones acciones">
                <input type="radio" name="opcion" id="consulta" value="c" required>
                <label for="consulta" id="lbl-consulta"><img src="..//img/consultar_productos.png" alt="">Consultar Productos</label>
                </div>
            </div>
            <div class="botones">
