...
<head>
    ...
    <title>Dulcería Arcada | Usuarios</title>
    ...
    <div class="formulario">
        <form action="acciones_usuarios.php" method="post">
            ...
            <div class="opciones">
                ...
                <label for="alta" id="lbl-alta"><img src="..//img/agregar_usuario.png" alt="">Agregar Usuario</label>
                </div>

                <div class="opciones acciones">
                <input type="radio" name="opcion" id="baja" value="b" required>
                <label for="baja" id="lbl-baja"><img src="..//img/eliminar_usuarios.png" alt="">Eliminar Usuario</label>
                </div>

                <div class="opciones acciones">
                <input type="radio" name="opcion" id="modificar" value="m" required>
                <label for="modificar" id="lbl-modificar"><img src="..//img/modificar_usuarios.png" alt="">Modificar Usuario</label>
                </div>
                <?php } ?>

                <div class="opciones acciones">
                <input type="radio" name="opcion" id="consulta" value="c" required>
                <label for="consulta" id="lbl-consulta"><img src="..//img/consultar_usuarios.png" alt="">Consultar Usuarios</label>
                </div>
            </div>
            <div class="botones">
