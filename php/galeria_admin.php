...
<head>
    ...
    <title>Dulcería Arcada | Galería</title>
            ...
            <div>
                ...
                <nav class="menu-op">
                    <ul class="lista">
                        ...
                        <li><a class="btn-menu-galeria select" href="galeria_admin.php">Galería</a></li>
    ...
    <div class="formulario">
        <form action="acciones_productos.php" method="post">
            ...
            <div class="opciones">
                ...
                <label for="alta" id="lbl-alta"><img src="..//img/agregar_galeria.png" alt="">Agregar Imagen</label>
                </div>

                <div class="opciones acciones">
                <input type="radio" name="opcion" id="baja" value="b" required>
                <label for="baja" id="lbl-baja"><img src="..//img/eliminar_galeria.png" alt="">Eliminar Imagen</label>
                </div>
                <?php } ?>
                <div class="opciones acciones">
                <input type="radio" name="opcion" id="consulta" value="c" required>
                <label for="consulta" id="lbl-consulta"><img src="..//img/consultar_galeria.png" alt="">Consultar Imágenes</label>
                </div>
            </div>
            <div class="botones">
